...
#if defined(CONFIG_MMC_CRYPTO) && !defined(CONFIG_ARCH_TEGRA)
...
#else
#define MMC_CAP2_ONLY_1V8_SIGNAL_VOLTAGE	0
#define MMC_CAP2_FORCE_RESCAN			0
#define MMC_CAP2_PERIODIC_CACHE_FLUSH		0
#define MMC_CAP2_BROKEN_CARD_BUSY_DETECT	0
#define MMC_CAP2_SD_EXPRESS_SUPPORT		0
#endif
